...
5. Run a native development build with the SDK included. Web and Expo Go do not process purchases in this implementation.
...
The offer includes purchase, restore, and Customer Center actions. Closing or cancelling the paywall retains free access. Web billing is not implemented. The current gates apply to client-side filtering and export; any future paid server feature must independently verify entitlements on the server.
